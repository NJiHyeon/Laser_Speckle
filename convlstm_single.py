            ...
            for bs in batch_size:
                for bn in batch_norm:
                    for sf in skip_frames:
                        ...
                        save_model_path = f'./convlstm/single/{freq}/weights/hd{hd}_do{do}_bs{bs}_bn{bn}_sf{sf}/'
                        save_pred_path = f'./convlstm/single/{freq}/predictions/hd{hd}_do{do}_bs{bs}_bn{bn}_sf{sf}/'
                        log_path = f'./convlstm/single/{freq}/log/hd{hd}_do{do}_bs{bs}_bn{bn}_sf{sf}/'
                        ...
                        result.to_csv(f'finetune_result/convlstm_single_{freq}.csv', index=None)
