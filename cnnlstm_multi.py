            ...
            for nl in num_layers:
                for do2 in drop_p_lstm:
                    for bs in batch_size: 
                        ...
                        do2_col.append(do2)
                        bs_col.append(bs)
                        save_model_path = f'./cnnlstm/multi/weights/od{od}_do1{do1}_hd{hd}_nl{nl}_do2{do2}_bs{bs}/'
                        save_pred_path = f'./cnnlstm/multi/predictions/od{od}_do1{do1}_hd{hd}_nl{nl}_do2{do2}_bs{bs}/'
                        log_path = f'./cnnlstm/multi/log/od{od}_do1{do1}_hd{hd}_nl{nl}_do2{do2}_bs{bs}/'
                        ...
                        with open(os.path.join(save_pred_path, 'prediction.pickle'), 'wb') as f:
